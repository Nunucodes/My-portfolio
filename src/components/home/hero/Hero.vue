    ...
    <div class="hero__container">
      <div class="hero__left-pane">
        ...
        <div class="stack-icons">
          <img
            v-for="stackIcon in stackIcons"
            :key="stackIcon.id"
            class="stack-icons__icon"
            :src="stackIcon.asset"
            :alt="stackIcon.name"
          />
        </div>
        ...
        <div class="actions">
          <router-link to="/projects">
            <button class="action filled">Projects</button>
          </router-link>
          <router-link to="/contact">
            <button class="action outlined">Contact</button>
          </router-link>
        </div>
      </div>
